      ...
      <div className="section-shell">
        ...
        <div className="mt-14 grid gap-14 lg:grid-cols-[1fr_320px] lg:gap-24">
          ...
          <Reveal delay={.2} className="space-y-8">
            <div className="border-t border-[#222A27] pt-4"><p className="font-mono text-[10px] uppercase tracking-[.16em] text-[#53615b]">E-mail</p><p className="mt-3 text-sm text-[#9BA7A2]">Disponível em breve</p></div>
